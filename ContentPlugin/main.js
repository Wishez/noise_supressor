...
(function (factory) {
	...
	var _regexp = new RegExp('<img', 'ig');
	var _filteredWords = 'filteredWords';
	...
	var _insistenceOf = function _insistenceOf(obj, type) {
  ...
  *
  */
	var _showBlock = function _showBlock(node) {
...
var _DocumentFilter = require('./libs/DocumentFilter.js');

var _DocumentFilter2 = _interopRequireDefault(_DocumentFilter);
